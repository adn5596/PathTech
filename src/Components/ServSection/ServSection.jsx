...
import img4 from "../../assets/Img/path/Training & Coaching.png";
import img5 from "../../assets/Img/path/PPM_.png";
import img6 from "../../assets/Img/path/Citizen Developer.png";

import { useTranslation } from "react-i18next";
import { useSelector } from "react-redux";
import "./Serv.css"; // Include CSS for gradient text
...
const ServSection = () => {
  ...
  const selectedService = servs.find((item) => item.id === selectedId);
